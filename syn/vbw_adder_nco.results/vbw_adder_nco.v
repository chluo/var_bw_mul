...
module MFA_nco_7 ( a, b, ci, control, s, co );
  ...
  NAND2X0_RVT U2 ( .A1(a), .A2(b), .Y(n2) );
  OR2X1_RVT U3 ( .A1(a), .A2(b), .Y(n1) );
  AND2X1_RVT U4 ( .A1(n2), .A2(n1), .Y(n4) );
  NAND2X0_RVT U5 ( .A1(n4), .A2(ci), .Y(n6) );
  NAND2X0_RVT U6 ( .A1(n6), .A2(n2), .Y(n3) );
  AND2X1_RVT U7 ( .A1(n3), .A2(control), .Y(co) );
  OR2X1_RVT U8 ( .A1(n4), .A2(ci), .Y(n5) );
  AND2X1_RVT U9 ( .A1(n6), .A2(n5), .Y(s) );
endmodule
...
module vbw_adder_nco ( a, b, ci, control, s, co );
  ...
  adder_nco_WIDTH8_3 genblk1_4__adder_inst ( .a(a[39:32]), .b(b[39:32]), .ci(
        internal_carry[4]), .control(n1), .s(s[39:32]), .co(internal_carry[5])
         );
  adder_nco_WIDTH8_2 genblk1_5__adder_inst ( .a(a[47:40]), .b(b[47:40]), .ci(
        internal_carry[5]), .control(n2), .s(s[47:40]), .co(internal_carry[6])
         );
  adder_nco_WIDTH8_1 genblk1_6__adder_inst ( .a(a[55:48]), .b(b[55:48]), .ci(
        internal_carry[6]), .control(n1), .s(s[55:48]), .co(internal_carry[7])
         );
  adder_nco_WIDTH8_0 genblk1_7__adder_inst ( .a(a[63:56]), .b(b[63:56]), .ci(
        internal_carry[7]), .control(n2), .s(s[63:56]), .co(internal_carry[8])
         );
  INVX0_RVT U8 ( .A(control[1]), .Y(n2) );
  NOR2X0_RVT U9 ( .A1(control[1]), .A2(control[0]), .Y(internal_control_3_) );
  AND2X1_RVT U10 ( .A1(internal_control_3_), .A2(internal_carry[8]), .Y(co) );
  AND2X1_RVT U11 ( .A1(internal_control_3_), .A2(ci), .Y(internal_carry[0]) );
