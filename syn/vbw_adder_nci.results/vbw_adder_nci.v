...
module MFA_nci_7 ( a, b, ci, control, s, co );
  ...
  AND2X1_RVT U1 ( .A1(control), .A2(ci), .Y(n1) );
  FADDX1_RVT U2 ( .A(b), .B(a), .CI(n1), .CO(co), .S(s) );
endmodule
...
module vbw_adder_nci ( a, b, ci, control, s, co );
  ...
  input ci;
  output co;
  wire   internal_control_4_, n2, n3, n4;
  wire   [8:0] internal_carry;

  adder_nci_WIDTH8_7 genblk1_0__adder_inst ( .a(a[7:0]), .b(b[7:0]), .ci(
        internal_carry[0]), .control(n3), .s(s[7:0]), .co(internal_carry[1])
         );
  ...
  adder_nci_WIDTH8_5 genblk1_2__adder_inst ( .a(a[23:16]), .b(b[23:16]), .ci(
        internal_carry[2]), .control(n3), .s(s[23:16]), .co(internal_carry[3])
         );
  adder_nci_WIDTH8_4 genblk1_3__adder_inst ( .a(a[31:24]), .b(b[31:24]), .ci(
        internal_carry[3]), .control(n2), .s(s[31:24]), .co(internal_carry[4])
         );
  ...
  adder_nci_WIDTH8_1 genblk1_6__adder_inst ( .a(a[55:48]), .b(b[55:48]), .ci(
        internal_carry[6]), .control(n3), .s(s[55:48]), .co(internal_carry[7])
         );
  ...
  AND2X1_RVT U12 ( .A1(n3), .A2(n4), .Y(internal_control_4_) );
  AND2X1_RVT U13 ( .A1(internal_control_4_), .A2(internal_carry[8]), .Y(co) );
  AND2X1_RVT U14 ( .A1(internal_control_4_), .A2(ci), .Y(internal_carry[0]) );
endmodule
